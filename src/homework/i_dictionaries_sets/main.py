...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            # Delete item or quantity
            while True:  # Add a loop to handle multiple deletions
                ...
                if another_deletion not in ['y', 'yes']:
                    break  # Break out of the deletion loop if not 'Y' or 'yes    
...
def main():
        ...
        while True:
            ...
            if choice == '1':
                ...
                # Delete item
                while True: #Add loop to handle multi deletions
                    item_name = str(input("Enter the item name to delete: "))
                    result = remove_inventory_widget(inventory, item_name)
                    print(result)
                ...
                menu = None
                menu = input("press enter to go to the main menu")
                if menu != None:
